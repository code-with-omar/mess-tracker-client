...
import useUsersFind from "../../../Hooks/useUsersFind";
import usePerUserDetails from "../../../Hooks/usePerUserDetails";
import { CiBank } from "react-icons/ci";
import { TbCoinTakaFilled } from "react-icons/tb";
import { GiHotMeal } from "react-icons/gi";
import { AiOutlineUnderline } from "react-icons/ai";
...
const UserProfile = () => {
    ...
    const { mealRate, loading, individualExtra, mealCost, totalCost, due, totalUserDeposit, totalUserMeal } = usePerUserDetails({ user })
    const [usersFind,refetch] = useUsersFind({email})
    const { name, department, district, } = usersFind?.[0] || {};
    return (
        <div>
            {
                photoURL ?
                    <>
                        ...
                        <div className="grid md:grid-cols-4 bg-[#0f1729] my-0 md:my-10">
                            <div className="border-b-2 md:border-r-2 py-5 px-5 text-[#25ff00]">
                                <h2 className="text-4xl font-extrabold text-center mb-5">Total Deposit</h2>
                                <div className="flex justify-center items-center font-extrabold  text-7xl mb-5 text-[#c3ff5c]">
                            ...
                            <div className="border-b-2 md:border-r-2 py-5 px-5 text-white">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-5xl font-extrabold">{mealRate.toFixed(2)}</span>
                                    <AiOutlineUnderline />
                                </div>
                            </div>
                            <div className="border-b-2 md:border-r-2 py-5 px-5  text-[#0097ff]">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-center font-extrabold">{totalUserMeal.toFixed(2)}</span>
                                    <AiOutlineUnderline />
                                </div>
                            </div>
                            <div className="border-b-2 md:border-r-2 py-5 px-5  text-[#0097ff]">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-center font-extrabold">{individualExtra.toFixed(2)}</span>
                                    <TbCoinTakaFilled />
                                </div>
                            </div>
                        </div>
                        <div className="grid md:grid-cols-3 bg-[#0f1729] my-0 md:my-10">
                            <div className="border-b-2 md:border-r-2 py-5 px-5 text-[#9b8fcd]">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-center font-extrabold">{mealCost.toFixed(2)}</span>
                                    <TbCoinTakaFilled />
                                </div>
                            </div>
                            <div className="border-b-2 md:border-r-2 py-5 px-5 text-[#ff00d3]">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-5xl font-extrabold">{totalCost.toFixed(2)}</span>
                                    <TbCoinTakaFilled />
                                </div>
                            </div>
                            <div className="border-b-2 md:border-r-2 py-5 px-5  text-[#ffb80a]">
                                ...
                                <div className="flex justify-center items-center text-5xl">
                                    <span className="text-center font-extrabold">{due.toFixed(2)}</span>
                                    <TbCoinTakaFilled />
                                </div>
                            </div>
                        </div>
